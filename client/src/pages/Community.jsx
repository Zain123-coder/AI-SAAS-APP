...
const Community = () => {
  ...
  const[loading,setLoading]=useState(true)  //by default loading is true when fetch the data loading is false
  ...
  return !loading ? (
    ...
    <div className='bg-white h-full w-full rounded-xl overflow-y-scroll'>
      {creations.map((creation,index)=>(
        <div key={index} className='relative group inline-block pl-3 pt-3 w-full lg:max-w-1/3'>
