...
const ReviewResume = () => {
  ...
  return (
    ...
    <button className='w-full flex justify-center items-center gap-2 bg-gradient-to-r         from-[#0ac843] to-[#1cde1c] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer  '>
